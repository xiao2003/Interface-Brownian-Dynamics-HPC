function [xe,ye,Xads,Yads,t_r] = Sub_JumpingBetweenEachFrame(x0,y0,XYd,DataTrans)
    ...
    for i=1:100000000
        ...
        if m<adR^2
            ...
            switch DistributionMode
                ...
                case 2
                    if Timeindex > 0
                        t_ads = Sub_GenerateExponentialWithMean(tm_ads, 1); % 指数分布的参数λ与均值的关系：λ = 1/meanValue
                    else
                ...
                case 3
                    if len == 0
                     ...
                     t_ads = Sub_GenerateUniformWithMean(tm_ads, range, 1);    
             end
        ...
        if tclock>=t_tot
            ...
            t_r = tclock-t_tot;      % subsequent adsorption time in the next frame
